...
namespace JSL
{
    ...
    public static class ShipModuleType
    {
        ...
        public enum Enum
        {
            ...
            C_DisruptionAfterEMP_1,
            C_DisruptionAfterEMP_2,
            __COUNT__
        }
        ...
        private static EnumInfo[] All = new EnumInfo[]
        {
            ...
            new EnumInfo { Title = "Corrosion after EMP",         Abbr = "Cor", Raw = "64c441c7ba5afa04c86e656d35cddfd3", PotencyCount = 2, Kind = ModuleKind.Custom,  Purpose = MajorItemPurpose.Weapon     },
            ...
            new EnumInfo { Title = "Hits on EMP restore shield",  Abbr = "Shl", Raw = "704bdac3db82ade45ad1690916d7ad1b", PotencyCount = 2, Kind = ModuleKind.Custom,  Purpose = MajorItemPurpose.Weapon     },
            new EnumInfo { Title = "Disruption after EMP (1)",    Abbr = "Dis", Raw = "594cfedb80c49f548be209204da1eed6", PotencyCount = 2, Kind = ModuleKind.Custom,  Purpose = MajorItemPurpose.Weapon     },
            new EnumInfo { Title = "Disruption after EMP (2)",    Abbr = "Dis", Raw = "a5331df01eb1f1147b27f8cb852c82ca", PotencyCount = 2, Kind = ModuleKind.Custom,  Purpose = MajorItemPurpose.Weapon     },
        };
    ...
    public static class PlayerWeaponModuleType
    {
        ...
        private static EnumInfo[] All = new EnumInfo[]
        {
            ...
            new EnumInfo { Title = "Melee heals after deflect",       Abbr = "Hel", Raw = "6da7dc2db0f033242a5b6990bae55e15", PotencyCount = 2, Kind = ModuleKind.Custom  },
